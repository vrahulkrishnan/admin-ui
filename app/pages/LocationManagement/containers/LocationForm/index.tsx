...
import { Grid, GridCol, TextInput, Textarea, SingleFileInput, MultipleFileInput, GroupButton } from 'components';

import { LocationFormTypes } from '../../types';
import messages from './messages';
import { LocationFormProps } from './types';

const LocationForm = ({ onView, onSubmit, isEdit, data }: LocationFormProps) => {
  const form = useForm<LocationFormTypes>({
    initialValues: {
      name: '',
      description: '',
      mainImage: null,
